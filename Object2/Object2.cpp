...
MatrixOnPaint& matrixOnPaint = matrixOnPaint.getInstance();
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_COPYDATA:
        SetWindowPos(hWnd, NULL, 650, 300, 650, 500, SWP_SHOWWINDOW);
        matrixOnPaint.CopyData(hWnd, wParam, lParam);
        break;
    case WM_COMMAND:
        {
    ...
    case WM_PAINT:
        {
            ...
            matrixOnPaint.OnPaint(hWnd, hdc);
            EndPaint(hWnd, &ps);
        }
        break;
    case WM_DESTROY:
